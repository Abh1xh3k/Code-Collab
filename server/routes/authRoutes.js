...
router.get('/google/callback',
    ...
    (req, res) => {
        try {
            ...
            console.log('Redirecting to:', `https://code-collab-three-smoky.vercel.app/room?token=${token}&userId=${req.user._id}&username=${req.user.username}`);
            res.redirect(`https://code-collab-three-smoky.vercel.app/room?token=${token}&userId=${req.user._id}&username=${req.user.username}`);
        } catch (error) {
